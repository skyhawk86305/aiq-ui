(function () {
  ...
  angular
    ...
    .component('protocolEndpointTable', {
      template: '<sf-table class="sf-layout-block" service="$ctrl.service" table-id="protocol-endpoint" control-bar="true" column-selection="true" items-per-page="25" export="true" footer-row-count="true"></sf-table>',
