...
export class VmwareAlarmsService {
  ...
  constructor(
    ...
    const columns = [
      ...
      { label: 'Last Modified Time', key: 'lastModifiedTime', width: 200, format: { filter: 'aiqDate', args:['yyyy-MM-dd HH:mm:ss'] }, filterComparators: SFFilterComparators.STRING_DEFAULT },
