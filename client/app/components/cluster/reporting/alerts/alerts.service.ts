(function () {
  ...
  function ClusterAlertTableService($filter, SFTableService, SFFilterComparators, CustomComparatorsService, DataService) {
    ...
    function getColumns() {
      return [
        ...
        {key: 'isResolved', label: 'Resolved', width: 160, filterComparators: CustomComparatorsService.resolvedComparators, format: {filter: 'tableBadgeBoolean'}},
        {key: 'severity', label: 'Severity', width: 160, filterComparators: CustomComparatorsService.alertSeverityComparators, format: {filter: 'tableBadgeAlertSeverity'}},
