  ...
  function VirtualNetworkTableService(SFTableService, SFFilterComparators, DataService) {
    ...
    function getColumns() {
      return [
        ...
        {key: 'svip', label: 'SVIP', filterComparators: SFFilterComparators.IP_ADDRESS_DEFAULT, format: {filter: 'string'}},
        {key: 'netmask', label: 'Netmask', filterComparators: SFFilterComparators.IP_ADDRESS_DEFAULT, format: {filter: 'string'}},
        {key: 'gateway', label: 'Gateway', filterComparators: SFFilterComparators.IP_ADDRESS_DEFAULT, format: {filter: 'string'}},
