(function () {
  ...
  angular
    ...
    .component('apiCollectionTable', {
      template: '<sf-table class="sf-layout-block" service="$ctrl.service" table-id="api-collection" control-bar="true" items-per-page="25" export="true" footer-row-count="true"></sf-table>',
