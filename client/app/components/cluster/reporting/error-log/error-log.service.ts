(function () {
  ...
  function ErrorLogTableService(SFTableService, SFFilterComparators, CustomComparatorsService, DataService) {
    ...
    const columns = [
      ...
      {key: 'date', label: 'Date', format: {filter: 'aiqDate'}, width: 175},
      ...
      {key: 'details', label: 'Details', filterComparators: [SFFilterComparators.CONTAINS], format: {filter:'string'}, minWidth: 200}
    ];
