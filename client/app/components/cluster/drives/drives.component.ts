(function () {
  ...
  angular
    ...
    .component('driveTable', {
      template: '<sf-table class="sf-layout-block" service="$ctrl.service" id="drive-table" table-id="drive" control-bar="true" items-per-page="25" quick-filter="$ctrl.quickFilter" export="true" footer-row-count="true"></sf-table>',
