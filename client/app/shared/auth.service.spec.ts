...
describe('Auth Service', function () {
  ...
  describe('.logout', function() {
    ...
    it('should make an $http GET request to /sessions/logout', function () {
      http.expectGET('/sessions/logout').respond(200, 'success');
      service.logout();
      http.flush();
      expect(userInfoService.clearUserInfo).toHaveBeenCalled();
    });
    ...
    describe('when logout fails', function () {
      it('should return an error', function () {
        http.expectGET('/sessions/logout').respond(500);
