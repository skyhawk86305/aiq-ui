...
describe('Table Badge Drives Filter', function () {
  ...
  it('should return all types of data', inject(function ($filter) {
    ...
    expect($filter('drivesTableBadge')(true)).toEqual('<div class="table-badge -normal">YES</div>');
    expect($filter('drivesTableBadge')(false)).toEqual('<div class="table-badge -critical">NO</div>');
    ...
    expect($filter('drivesTableBadge')('1000')).toEqual('<div class="table-badge -normal">1000</div>');
  }));
