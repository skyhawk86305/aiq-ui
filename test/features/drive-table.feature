...
@test
  Scenario: Feeding data from ListActiveNodes to sf-table (CLOUD-2898)
    ...
    And The "drive" table contains "ListActiveDrives" data with attrs: "driveID, nodeID, slot, capacity, serial, driveStats.lifeRemainingPercent, driveStats.reserveCapacityPercent, type"
