(function () {
    ...
    function ClusterSelectController($location, $routeParams, ClusterSelectService) {
        ...
        self.select = function (cluster) {
            var currentPath = $location.path(), defaultPath = '/reporting/overview', onClusterPath = currentPath.indexOf('/cluster/') >= 0, newPath = onClusterPath ? currentPath.replace(/\/cluster\/([0-9]*)/, '') : defaultPath;
...
//# sourceMappingURL=cluster-select.component.js.map