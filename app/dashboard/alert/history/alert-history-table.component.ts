(function () {
  ...
  angular
    ...
    .component('alertHistoryTable', {
      template: '<sf-table class="sf-layout-block alert-table" service="$ctrl.service" table-id="alert-history" ' +
        'multi-column-sort="true" control-bar="true" items-per-page="25" export="true"></sf-table>',
