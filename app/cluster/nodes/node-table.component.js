(function () {
    ...
    angular
        .module('aiqUi')
        .component('nodeTable', {
        template: '<sf-table class="sf-layout-block" service="$ctrl.service" table-id="node" control-bar="true" items-per-page="25"></sf-table>',
...
//# sourceMappingURL=node-table.component.js.map