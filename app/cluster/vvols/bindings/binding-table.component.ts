(function () {
  ...
  angular
    ...
    .component('bindingTable', {
      template: '<sf-table class="sf-layout-block" service="$ctrl.service" table-id="binding" control-bar="true" column-selection="true" items-per-page="25" export="true"></sf-table>',
