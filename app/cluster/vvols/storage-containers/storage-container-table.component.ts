(function () {
  ...
  angular
    ...
    .component('storageContainerTable', {
      template: '<sf-table class="sf-layout-block" service="$ctrl.service" table-id="storage-container" control-bar="true" column-selection="true" items-per-page="25" export="true"></sf-table>',
