(function () {
  ...
  angular
    .module('aiqUi')
    .component('hostTable', {
      template: '<sf-table class="sf-layout-block" service="$ctrl.service" table-id="host" control-bar="true" column-selection="true" items-per-page="25" export="true"></sf-table>',
