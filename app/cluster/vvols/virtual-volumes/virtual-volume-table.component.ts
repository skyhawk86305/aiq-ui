(function () {
  ...
  angular
    ...
    .component('virtualVolumeTable', {
      template: '<sf-table class="sf-layout-block" service="$ctrl.service" table-id="virtual-volume" control-bar="true" column-selection="true" items-per-page="25" export="true"></sf-table>',
